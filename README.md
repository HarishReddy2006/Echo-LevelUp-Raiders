...
Enemies react to the player's pulses. Using the pulse can alert enemies and trigger a chase.

### Level 3 — The Last Charge

A limited pulse-energy system forces the player to carefully manage every reveal.
...
* **Rendering:** HTML5 Canvas via Phaser's WebGL/Canvas renderer with Lights2D pipeline
* **Hosting:** GitHub Pages
* **Version Control:** Git & GitHub
* **Art:** Procedurally generated in code
* **Target Platform:** Web Browser

No external image assets are required for the game's visual elements.
...
Open `index.html` in a modern web browser such as Chrome, Firefox, or Edge.

### Option 2 — Local Server

For best results, serve the project folder using a local server:

```bash
npx serve .
```

Then open the localhost URL displayed in the terminal.
...
AI tools were used during the development and preparation of this project.
...
* Assisting with Phaser 3 implementation
* Debugging and development assistance

All final game design decisions, level design, gameplay tuning, testing, and implementation verification were performed by the team.

The team understands the submitted implementation and can explain the development decisions and functionality of the game.

---

## 🏆 Hackathon

**LevelUp Game Hackathon 2026 — Gamnexis**

**Team:** LevelUp Raiders
**Game:** Echo

This project was developed primarily during the LevelUp Game Hackathon 2026 for submission to Gamnexis.

---

## 📜 License / Submission Note

This project was created for the **LevelUp Game Hackathon 2026**.

All game visuals are original or procedurally generated within the project. The team has made reasonable efforts to ensure that the submitted project does not use unauthorized copyrighted assets.
